...
import ENDB from '../assets/bank-logos/ENDB.png';
...
export default {
  ...
  data() {
    return {
      search: '',
      options: [
        {logo: ModelBank, description: 'Model Bank', active: true},
        ...
        {logo: ENDB, description: 'ENDB',  active: false},
        {logo: FAB, description: 'FAB',  active: false},
        {logo: HSBC, description: 'HSBC',  active: false},
